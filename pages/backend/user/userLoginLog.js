    ...
    return <>
        <PageInfo>
            <div className={'cell p-3 flex-center'}>
                <button className={'btn-danger strong  ml-6 mr-auto'} onClick={handleClear}>清空</button>
                ...
                : <>
                    {data && data.list.length == 0
                        ...
                        : <>
                            ...
                            <div className={'cell-tools p-3 flex-center'}><PageButtons totalPage={data.total_page} total={data.total} tempQuery={tempQuery} setTempQuery={setTempQuery} setQuery={setQuery}/></div>
                        </>
                    }
                </>
            }
