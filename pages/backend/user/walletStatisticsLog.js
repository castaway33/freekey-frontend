...
const pageConf = {
    ...
    fields: [
        ...
        {field: 't3', name: '银行卡充值', renderFn: (d) => numeral(d.t3).format('0,00.00')},
        {field: 't4', name: 'Paypal充值', renderFn: (d) => numeral(d.t4).format('0,00.00')},
        {field: 't5', name: '人工扣除', renderFn: (d) => numeral(d.t5).format('0,00.00')},
    ]
}
